...
flags.DEFINE_string(
    "bert_config_file", './albert_xlarge_zh_183k/albert_config_xlarge.json',
    "The config json file corresponding to the pre-trained BERT model. "
    "This specifies the model architecture.")

flags.DEFINE_string("task_name", "medical_classify", "The name of the task to train.")

flags.DEFINE_string("vocab_file", './albert_xlarge_zh_183k/vocab.txt',
                    "The vocabulary file that the BERT model was trained on.")

flags.DEFINE_string(
    "output_dir", 'albert_large_output_checkpoints_7',
    "The output directory where the model checkpoints will be written.")

## Other parameters

flags.DEFINE_string(
    "init_checkpoint", "albert_xlarge_zh_183k/albert_model.ckpt",
