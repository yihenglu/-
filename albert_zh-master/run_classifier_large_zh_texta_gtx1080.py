...
# 解决Ubutu下UnicodeEncodeError: ‘ascii’ codec can’t encode characters in ordinal not in range(128)

os.environ["CUDA_VISIBLE_DEVICES"]='1'
print('running albert_zh-master/run_classifier.py...')
...
# flags.DEFINE_string(
#     "bert_config_file", './albert_large_zh_original/albert_config_xlarge.json',
#     "The config json file corresponding to the pre-trained BERT model. "
#     "This specifies the model architecture.")

flags.DEFINE_string(
    "bert_config_file", './albert_large_zh_original/albert_config_large.json',
    "The config json file corresponding to the pre-trained BERT model. "
    "This specifies the model architecture.")

flags.DEFINE_string("task_name", "medical_classify", "The name of the task to train.")

flags.DEFINE_string("vocab_file", './albert_large_zh_original/vocab.txt',
                    "The vocabulary file that the BERT model was trained on.")

flags.DEFINE_string(
    "output_dir", 'albert_large_output_checkpoints_14_2',
    "The output directory where the model checkpoints will be written.")

## Other parameters

flags.DEFINE_string(
    "init_checkpoint", "albert_large_zh_original/albert_model.ckpt",
...
flags.DEFINE_float("num_train_epochs", 9.0,
...
class MedicalClassificationProcessor(DataProcessor):
    ...
    # def get_train_examples(self, data_dir):
    #     """See base class."""
    #     print("get train examples from {}".format(os.path.join(data_dir, "train.csv")))
    ...
    #     """See base class."""
    #     return self._create_examples(
    #         self._read_tsv(os.path.join(data_dir, "train_shuffle_300.csv")), "dev")
    #
    # def get_test_examples(self, data_dir):
    #     """See base class."""
    #     return self._create_examples(
    ...
    #                 label = '0'
    #                 title = str(line[1])
    #                 if len(title) > FLAGS.max_seq_length - 3:
    #                     title = title[0:FLAGS.max_seq_length - 3]
    #                 text_a = tokenization.convert_to_unicode(title)
    #
    #                 # 剩下的文本取context中的前+后
    #                 context = str(line[2])
    #                 title_len = len(title)
    #                 context_len = FLAGS.max_seq_length - title_len
    #                 context_start_len = math.floor(context_len * 0.6)
    #                 context_end_len = math.floor(context_len * 0.4)
    #                 context = context[:context_start_len] + context[-context_end_len:]
    #                 text_b = tokenization.convert_to_unicode(context)
    #             else:
...
def main(_):
  ...
  processors = {
      "medical_classify":MedicalClassificationProcessor
  }
  ...
  if FLAGS.do_eval:
    ...
    with tf.gfile.GFile(output_eval_file, "a+") as writer:  # 好像是自己改的，以追加的方式写每一步的验证结果
...
if __name__ == "__main__":
  ...
  tf.app.run()
  time_end = time.time()
  print('run pregram cost {} s'.format(time_end - time_start))