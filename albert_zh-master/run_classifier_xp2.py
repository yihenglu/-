...
flags.DEFINE_string(
    "output_dir", 'albert_large_output_checkpoints_2',
...
class MedicalClassificationProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        """See base class."""
        print("get train examples from {}".format(os.path.join(data_dir, "train_shuffle_3700.csv")))
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "train_shuffle_3700.csv")), "train")
        # dev_0827.tsv
